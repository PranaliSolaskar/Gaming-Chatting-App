 ...
 * @author Lenovo
 */
public class tictactoe_menu extends javax.swing.JFrame {
    ...
    private void HowToPlayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HowToPlayActionPerformed
            tictactoe_rules l= new tictactoe_rules();
            l.setVisible(true);
            this.dispose();
            // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(tictactoe_menu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new tictactoe_menu().setVisible(true);
            }
        });
    }
